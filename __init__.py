...
===============================================================================
  ...
  Module: Jigsaw Core Nodes (Weaver, Accelerator, Harmonizer, Universal VAE Merge & Auto Tile Factor)
...
from .jigsaw_auto_tile_factor import JigsawAutoTileFactor
...
def print_zeus_branding():
    ...
    print(f"  {bold}{green}[SUCCESS]{reset}        📏 ⚡ [ZEUS.ONL] Jigsaw Auto Tile Factor injected.")
